...
```
const blurb =
  "🌟 BEST IN WEST — " + name.toUpperCase() + " | " + location + "\n\n" +
...
<div style={{ fontSize: “11px”, letterSpacing: “6px”, color: “#4a9eff”, textTransform: “uppercase”, marginBottom: “12px”, fontFamily: “monospace” }}>
Option Care Health · West Operations
</div>
<h1 style={{ fontSize: “42px”, fontWeight: “700”, color: “#ffffff”, margin: “0 0 8px 0”, lineHeight: 1.1 }}>
⭐ Best in West
</h1>
...
```
    ...
    {step < 3 && (
      <div>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "20px" }}>
          <div>
            <label style={{ display: "block", fontSize: "11px", letterSpacing: "2px", textTransform: "uppercase", color: "#4a7aaa", marginBottom: "8px", fontFamily: "monospace" }}>
              Colleague Name
            </label>
            <input
              value={name}
              ...
              style={{ width: "100%", padding: "12px 14px", borderRadius: "10px", border: "1px solid rgba(255,255,255,0.1)", background: "rgba(255,255,255,0.05)", color: "#c8dff5", fontSize: "14px", fontFamily: "Georgia, serif", outline: "none", boxSizing: "border-box" }}
            />
          </div>
          <div>
            <label style={{ display: "block", fontSize: "11px", letterSpacing: "2px", textTransform: "uppercase", color: "#4a7aaa", marginBottom: "8px", fontFamily: "monospace" }}>
        ...
        <div style={{ marginBottom: "20px" }}>
          ...
          <textarea
            ...
            placeholder="She stayed two hours late to ensure a patient's infusion was ready..."
            style={{ width: "100%", padding: "12px 14px", borderRadius: "10px", border: "1px solid rgba(255,255,255,0.1)", background: "rgba(255,255,255,0.05)", color: "#c8dff5", fontSize: "14px", fontFamily: "Georgia, serif", outline: "none", boxSizing: "border-box", height: "100px", resize: "vertical" }}
          />
        </div>
            ...
            {PILLARS.map((p) => (
              <button
                ...
                style={{
                  ...
                  border: "1px solid " + (pillar === p.id ? "rgba(74,158,255,0.6)" : "rgba(255,255,255,0.08)"),
        ...
        <button
          ...
          style={{
            ...
            background: (!name || !location || !story || !pillar) ? "rgba(255,255,255,0.05)" : "linear-gradient(135deg, #1a6fff, #0a4fd4)",
    ...
    {step === 3 && generated && (
      <div>
        <div style={{
          ...
          whiteSpace: "pre-wrap", color: "#c8dff5", fontSize: "15px", lineHeight: "1.7"
        }}>
          {generated}
        </div>
  ...
  <p style={{ color: "#2a4a6a", fontSize: "12px", marginTop: "24px", fontStyle: "italic", fontFamily: "monospace" }}>
